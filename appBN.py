"""
Streamlined Streamlit application for Note-Summarizer.
Features a clean, dark interface with sidebar settings and focused output.
"""
...
def main():
    ...
    elif not "view_summary" in st.session_state:
